            ...
            <div class="container text-center text-white header">
                ...
                <div class="ex">
                    <form action="Registration_Validate.jsp" method="post">
                        ...
                        <br>
                        <input type="text" placeholder="User Name" class="input-field" name="username"><br>
                        <input type="text" placeholder="Full Name" class="input-field" name="fullname"><br>
                        <input type="text" placeholder="Email" class="input-field" name="email"><br>
                        <input type="long" placeholder="Mobile" class="input-field" name="phone"><br>
                        <input type="password" placeholder="Password" class="input-field" name="password"><br>
                        <input type="password" placeholder="Re-Enter Password" class="input-field" name="repass"><br>
                        <input type="submit" value="Register" />
                    </form>
                    <a href="Login_Form.jsp">Existing User</a>
                </div>
            </div>
        </section>
    </body>
